...
|----|---------------------------|---------|:----:|--------------|------------|------|--------------|
| 1  | submit-registration       | FR-01   |  1   | spec ←       | —          | [spec](specs/submit-registration.md) | 2026-04-29   |
...
(Empty — first migration will be generated by `/architecture:new-feature` for FR-01.)
